...
public class Home {
    ...
    public Home(int userId, String userRole) {
        ...
        DatabaseUtil.populate(tableModel, "unclaimed", null);

        categoryFilter();;
        setupListeners(tableModel);

        // Disable for client role
        historyBtn.setEnabled("admin".equals(userRole));
        ...
        historyBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if ("admin".equals(userRole)) { // Check if the user is admin
                    JFrame historyFrame = new JFrame("History");
                    History settings = new History(userId);
                    historyFrame.setContentPane(settings.getMainPanel());
        ...
        categoryFilter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                DatabaseUtil.populate(tableModel, "unclaimed", selectedCategory);
            }
        });
    }
